...
import TransportWebHID from '@ledgerhq/devices/lib/hid-framing'
...
export default class LedgerBridge {
      ...
      if (e && e.data && e.data.target === 'LEDGER-IFRAME') {
        ...
        switch (action) {
          ...
          case 'ledger-sign-personal-message':
            ...
            break
          case 'ledger-get-public-encryption-key':
            this.getPublicEncryptionKey(replyAction, messageId)
            break
  ...
  async getPublicEncryptionKey(replyAction, hdPath, messageId) {
    try {
      await this.makeApp()
      const res = await this.app.getEIP1024PublicEncryptionKey(hdPath)
